...
extern NSString *const ZZRouterParameterURL;
extern NSString *const ZZRouterParameterCompletion;
extern NSString *const ZZRouterParameterUserInfo;

/**
 *  routerParameters 里内置的几个参数会用到上面定义的 string
 */
typedef void (^ZZRouterHandler)(NSDictionary *routerParameters);

/**
 *  需要返回一个 object，配合 objectForURL: 使用
 */
typedef id (^ZZRouterObjectHandler)(NSDictionary *routerParameters);
 ...
 *
 *  #define ZZ_ROUTE_BEAUTY @"beauty/:id"
 *  [ZZRouter generateURLWithPattern:ZZ_ROUTE_BEAUTY, @[@13]];
 *
 *
